    ...
    <div ref={containerRef} className="w-full space-y-6">
      ...
      <div className="glass-card p-6 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle at 100% 0%, rgba(232, 93, 58, 0.2) 0%, transparent 50%)',
          }}
        />

        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-terracotta-500 to-gold-500 flex items-center justify-center shadow-warm-glow">
          ...
          >
            {tracks.slice(0, 15).map((track, index) => (
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-terracotta-500/20 to-gold-500/20 flex items-center justify-center flex-shrink-0">
                  <PlayIcon className="w-4 h-4 text-terracotta-500" />
                </div>
      ...
      {!isAuthenticated ? (
        ...
        <div className="space-y-4">
          {/* Connected status */}
          <div className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-teal-500/10 border border-teal-500/20">
            <CheckIcon className="w-5 h-5 text-teal-500" />
            <span className="text-sm font-medium text-teal-500">Connected to YouTube</span>
          </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="glass-card max-w-md w-full p-6 relative overflow-hidden">
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(circle at 0% 100%, rgba(212, 168, 83, 0.2) 0%, transparent 50%)',
              }}
            />
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gold-500/20 flex items-center justify-center">
                  <ExclamationTriangleIcon className="w-5 h-5 text-gold-500" />
                </div>
                <h3
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-xl font-medium bg-gradient-to-r from-terracotta-500 to-gold-500 text-white hover:opacity-90 transition-opacity cursor-pointer"
                >
                  Continue
                </button>
              </div>
          ...
          <div
            ...
            style={{
              background: result.success
                ? 'radial-gradient(circle at 50% 0%, rgba(45, 125, 111, 0.2) 0%, transparent 50%)'
            ...
            {result.success ? (
              <>
                ...
                {result.failedTracks > 0 && (
                  <div className="flex items-center gap-2 py-2 px-3 rounded-lg bg-gold-500/10 text-gold-600 dark:text-gold-400 text-sm mb-4">
                ...
                {result.playlistId && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 py-3 px-5 rounded-xl bg-gradient-to-r from-terracotta-500 to-gold-500 text-white font-medium hover:opacity-90 transition-opacity cursor-pointer"
                  >
