      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section ref={heroRef} className="text-center py-16 md:py-24">
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            <div className="hero-icon w-14 h-14 rounded-2xl bg-gradient-to-br from-terracotta-500 to-terracotta-600 flex items-center justify-center shadow-warm-glow rotate-[-8deg]">
            ...
            <div className="hero-icon w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center shadow-teal-glow rotate-[8deg]">
          ...
          >
            Transform your{' '}
            <span className="font-semibold text-terracotta-500">Shazam discoveries</span>{' '}
            into curated{' '}
            <span className="font-semibold text-teal-500">YouTube playlists</span>{' '}
            in seconds
          </p>
        ...
        <section ref={stepsRef} className="space-y-8" id="how-it-works">
          ...
          <div className="step-card glass-card p-6 sm:p-8 relative overflow-hidden">
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(circle at 0% 0%, rgba(232, 93, 58, 0.2) 0%, transparent 50%)',
              }}
            />
            ...
            <div className="relative z-10">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                <div className="flex items-start gap-4">
                  {/* Step number */}
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-terracotta-500 to-gold-500 flex items-center justify-center flex-shrink-0 shadow-warm-glow">
                    <span
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-terracotta-600 to-gold-600 text-white font-bold shadow-warm-glow hover:opacity-90 transition-all duration-300 cursor-pointer group"
                >
                  Export from Shazam
          ...
          <div className="step-card glass-card p-6 sm:p-8 relative overflow-hidden">
            ...
            <div
              className="absolute inset-0 opacity-10"
              style={{
                background: 'radial-gradient(circle at 100% 0%, rgba(212, 168, 83, 0.2) 0%, transparent 50%)',
              }}
            />
            ...
            <div className="relative z-10">
              <div className="flex items-start gap-4 mb-6">
                {/* Step number */}
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-gold-500 to-gold-600 flex items-center justify-center flex-shrink-0 shadow-gold-glow">
                  <span
                    className="text-xl font-bold text-white"
                    style={{ fontFamily: "'Bricolage Grotesque', serif" }}
                  >
          ...
          {tracks.length > 0 && (
            <div className="step-card glass-card p-6 sm:p-8 relative overflow-hidden">
              ...
              <div
                className="absolute inset-0 opacity-10"
                style={{
                  background: 'radial-gradient(circle at 50% 100%, rgba(45, 125, 111, 0.2) 0%, transparent 50%)',
                }}
              />
              ...
              <div className="relative z-10">
                <div className="flex items-start gap-4 mb-6">
                  {/* Step number */}
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center flex-shrink-0 shadow-teal-glow">
                    <span
                      className="text-xl font-bold text-white"
                      style={{ fontFamily: "'Bricolage Grotesque', serif" }}
                    >
        ...
        <footer className="mt-16 text-center">
          <div className="glass-card inline-flex items-center gap-3 px-6 py-3 rounded-full">
            ...
            <GlobeAltIcon className="w-4 h-4 text-gold-500" />
          </div>
        </footer>
      </div>
    </div>
